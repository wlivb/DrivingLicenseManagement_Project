...
namespace PresentationLayer.Licenses.Detain_License
{
    public partial class frmDetainLicenseApplication : Form
    {
        ...
        private void btnDetain_Click(object sender, EventArgs e)
        {
            ...
            _DetainID = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.Detain((decimal)Convert.ToSingle(txtFineFees.Text), clsGlobal.CurrentUser.DTO.UserID);
            if (_DetainID == -1)
            {
